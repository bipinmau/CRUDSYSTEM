...
namespace DRDOAssignment.Migrations
{
    /// <inheritdoc />
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    DomainName = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CustomerInfos_Districts_DistrictId",
                        column: x => x.DistrictId,
                        principalTable: "Districts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CustomerInfos_Genders_GenderId",
                        column: x => x.GenderId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomerInfos_DistrictId",
                table: "CustomerInfos",
                column: "DistrictId");

            migrationBuilder.CreateIndex(
                name: "IX_CustomerInfos_GenderId",
                table: "CustomerInfos",
                column: "GenderId");
